...
var AppComponent = /** @class */ (function () {
    function AppComponent(oauthService, location) {
...
var AttendeesComponent = /** @class */ (function () {
    function AttendeesComponent(attendeeService, oauthService) {
        var _this = this;
        ...
        this.oauthService.tryLogin().then(function (result) {
            if (_this.oauthService.hasValidAccessToken()) {
                _this.fetchMettupEvents();
            }
        });
    }
    AttendeesComponent.prototype.login = function () {
        this.oauthService.initImplicitFlow();
    };
    AttendeesComponent.prototype.isLoggedIn = function () {
    ...
    AttendeesComponent.prototype.highResPhotoUrl = function (photo) {
        var photoUrl = this.notFoundPhoto;
        if (photo) {
    ...
    AttendeesComponent.prototype.randomAttendee = function () {
        ...
        if (this.attendees.length === 0) {
            ...
            this.attendeeService.getMemberFull(winner_1)
    ...
    AttendeesComponent.ctorParameters = function () { return [
...
var wjugUrlBase = corsAnywhere + "https://api.meetup.com/WroclawJUG/events/";
var membersUrlBase = corsAnywhere + "https://api.meetup.com/members/";
var AttendeesService = /** @class */ (function () {
    function AttendeesService(httpClient) {
        this.httpClient = httpClient;
    }
    AttendeesService.prototype.getMeetupEvents = function () {
        return this.httpClient.get(this.buildMeetupEventsUrl())
            .toPromise()
            .catch(this.handleError);
    };
    AttendeesService.prototype.getAttendees = function (eventId) {
        console.log('getAttendees');
        return this.httpClient.get(this.buildLastMeetupUrl(eventId))
            .toPromise()
            .catch(this.handleError);
    };
    AttendeesService.prototype.getMemberFull = function (attende) {
    ...
    AttendeesService.prototype.buildLastMeetupUrl = function (meetupId) {
        return "" + wjugUrlBase + meetupId + "/attendance";
    };
    // example https://api.meetup.com/WroclawJUG/events?&sign=true&photo-host=public&page=20
    AttendeesService.prototype.buildMeetupEventsUrl = function () {
        return wjugUrlBase + "?scroll=recent_past";
    };
    AttendeesService.prototype.buildMemberFullUrl = function (id) {
    ...
    AttendeesService.ctorParameters = function () { return [
